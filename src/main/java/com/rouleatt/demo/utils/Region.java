...
public enum Region {
    ...
    GYEONGGI("gyenggi", "경기도", "경기",126.182794, 36.990600, 127.915085, 38.300788),
    ...
    Region(String engName, String fullName, String shortName, double minX, double minY, double maxX, double maxY) {
